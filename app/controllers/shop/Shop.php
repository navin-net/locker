...
class Shop extends MY_Shop_Controller
{
    ...
    public function page($slug)
    {
        ...
        $careers                   = $this->shop_model->getJobs();
        $last_career               = $this->shop_model->getLastCareers(6);
        $this->data['total_products'] = $this->shop_model->totalProducts();
        $this->data['total_partners'] = $this->shop_model->totalPartners();
        $this->data['page']         = $page;
        $this->data['page_title']   = $page->title;
        $this->data['careers']      = $careers;
        $this->data['last_careers'] = $last_career;
    ...
    public function products($category_slug = null, $subcategory_slug = null, $brand_slug = null, $promo = null)
    {
        ...
        $this->data['brands']     = $this->shop_model->getBrands();
        $this->data['categories'] = $this->shop_model->getCategories();
    ...
    public function job_detail($id)
    {
        ...
        $this->session->set_userdata('requested_page', $this->uri->uri_string());
        $this->data['error'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('error');
        $career                   = $this->shop_model->getCareerByID($id);

        $this->data['career']     = $career;
        $this->data['page_title'] = lang('job-detail');
        $this->data['page_desc']  = '';
        $this->page_construct('pages/job-detail', $this->data);
    }
    public function event_detail($id)
    {
        ...
        $this->session->set_userdata('requested_page', $this->uri->uri_string());
        $this->data['error'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('error');
        $event_detail = $this->shop_model->getEventByID($id);
        $speakers     = $this->shop_model->getEventSpeakerByID($event_detail->id);
        // $this->sma->print_arrays($speakers);
        $this->data['event_detail']  = $event_detail;
        $this->data['speakers']      = $speakers;
        $this->data['events']        = $this->shop_model->getAllEvents();
        $this->data['page_title']    = lang('event_detail');
        $this->data['page_desc']     = '';
        $this->page_construct('pages/event-details', $this->data);
    }
    ...
    public function event_register()
    {
        ...
        if ($this->form_validation->run() == true && $this->shop_model->insertEvent($data)) {
            redirect($_SERVER['HTTP_REFERER']);
        }
    }
    ...
    public function news_details($id)
    {
        ...
        $news                      = $this->shop_model->getNewsByID($id);
        $tags                      = $this->shop_model->getNewsTags($news->id);
        
        $this->data['news_detail']          = $news;
        $this->data['tags']                 = $tags;
        $this->data['last_news_detail']     = $this->shop_model->getLastNewsDetail(5);
        $this->data['achives']              = $this->shop_model->getAchiveDate();
        $this->data['cate_news']            = $this->shop_model->getCategoryNews();
        $this->data['page_title']           = lang('job-detail');
        $this->data['page_desc']            = '';
        $this->page_construct('pages/news-details', $this->data);
    }
    ...
    public function academy()
    {
        ...
        $events                   =  $this->shop_model->getEvents('workshop');

        $this->data['events']     = $events;
        $this->data['page_title'] = lang('academy');
        $this->data['page_desc']  = '';
        $this->page_construct('pages/academy', $this->data);
    }
    ...
    public function news_event()
    {
        ...
        $this->session->set_userdata('requested_page', $this->uri->uri_string());
        $this->data['error'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('error');
        $achieve = $this->input->get('achieve');
        ...
        $news = $this->shop_model->getAllNews();
        // $this->sma->print_arrays($news);
        $events = $this->shop_model->getEvents('event');
        $this->data['news']       = $news;
        $this->data['events']     = $events;
        $this->data['page_title'] = lang('news & Event');
        $this->data['page_desc']  = '';
        $this->page_construct('pages/news-events', $this->data);
    }

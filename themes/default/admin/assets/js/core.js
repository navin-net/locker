...
$(document).ready(function () {
    ...
    //partner
    $('body').on('click', '.partner_link td:not(:first-child)', function () {
        $('#myModal').modal({
            remote: site.base_url + 'partners/edit_partner/' + $(this).parent('.partner_link').attr('id'),
        });
        $('#myModal').modal('show');
    });
    //careers
     $('body').on('click', '.career_link td:not(:first-child)', function () {
        $('#myModal').modal({
            remote: site.base_url + 'careers/edit_career/' + $(this).parent('.career_link').attr('id'),
        });
        $('#myModal').modal('show');
    });
     //news
        $('body').on('click', '.new_link td:not(:first-child)', function () {
        $('#myModal').modal({
            remote: site.base_url + 'news/edit_new/' + $(this).parent('.new_link').attr('id'),
        });
        $('#myModal').modal('show');
    });
    //workshops
    $('body').on('click', '.event_link td:not(:first-child)', function () {
    $('#myModal').modal({
            remote: site.base_url + 'workshops/edit/' + $(this).parent('.event_link').attr('id'),
    });
    $('#myModal').modal('show');
    });
    //brands

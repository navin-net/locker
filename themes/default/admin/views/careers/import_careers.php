...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('import_careers'); ?></h4>
        </div>
        <?php
        $attrib = ['class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form'];
        echo admin_form_open_multipart('careers/import_careers', $attrib)
        ?>
        <div class="modal-body">
            <a href="<?php echo base_url(); ?>assets/csv/sample_careers.csv" class="btn btn-primary pull-right">

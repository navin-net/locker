                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <?= form_input('contact_name', set_value('contact_name', $shop_settings->contact_name), 'class="form-control tip" id="contact_name" required="required"'); ?>
                        </div>
                        <div class="form-group">
                            <?= lang('email', 'email'); ?>
                ...
                <?php
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <?= form_input('address', set_value('address', $shop_settings->address), 'class="form-control tip" id="address" required="required"'); ?>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <?= lang('map_option', 'map_link'); ?>
                            <?= form_input('map_link', set_value('map_link', $shop_settings->map_link), 'class="form-control tip" id="map_link"'); ?>
                        </div>
                        <div class="form-group">
                            <?= lang('total_areas', 'total_areas'); ?>
                            <?= form_input('total_areas', set_value('total_areas', $shop_settings->total_areas), 'class="form-control tip" id="total_areas"'); ?>
                        </div>
                        <div class="form-group">
                            <?= lang('total_customers', 'total_customers'); ?>
                            <?= form_input('total_customers', set_value('total_customers', $shop_settings->customers), 'class="form-control tip" id="total_customers"'); ?>
                        </div>
                    </div>

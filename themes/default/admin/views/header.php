 ...
 -->
                            <li class="mm_news">
                                <a class="dropmenu" href="#">
                                    ...
                                    <span class="text"> <?= lang('news'); ?> </span>
                                    <span class="chevron closed"></span>
                                </a>
                                <ul>
                                    <li id="news_index">
                                        <a class="submenu" href="<?= admin_url('news'); ?>">
                                            <i class="fa fa-newspaper-o"></i>
                                            <span class="text"> <?= lang('list_news'); ?></span>
                                        </a>
                                    </li>
                                    <li id="news_tags">
                                        <a class="submenu" href="<?= admin_url('news/tags'); ?>">
                                            <i class="fa fa-tags"></i>
                                            <span class="text"> <?= lang('tags'); ?></span>
                                        </a>
                                    </li>
                                    <li id="news_categories">
                                        <a class="submenu" href="<?= admin_url('news/categories'); ?>">
                            ...
                            <li class="mm_partners">
                                <a class="submenu" href="<?= admin_url('partners'); ?>">
                                    <i class="fa fa-random"></i>
                                    <span class="text"> <?= lang('partners'); ?></span>
                                </a>
                            </li>

                            <li class="mm_careers">
                                <a class="submenu" href="<?= admin_url('careers'); ?>">
                                    <i class="fa fa-info-circle"></i><span class="text"> <?= lang('careers'); ?></span>
                                </a>
                            </li>
                            <li class="mm_workshops">
                                <a class="dropmenu" href="#">
                                    <i class="fa fa-newspaper-o"></i>
                                    <span class="text"> <?= lang('workshops'); ?> </span>
                                    <span class="chevron closed"></span>
                                </a>
                                 <ul>
                                <li id="workshops_index">
                                    <a class="submenu" href="<?= admin_url('workshops'); ?>">
                                    <i class="fa fa-newspaper-o"></i>
                                    <span class="text"> <?= lang('List_evnets_or_workshop'); ?></span>
                                </a>
                                </li>
                                <li id="workshops_speakers">
                                    <a class="submenu" href="<?= admin_url('workshops/speakers'); ?>">
                                    <i class="fa fa-newspaper-o"></i>
                                    <span class="text"> <?= lang('List_speaker'); ?></span>
                                </a>
                                </li>
                                  <li id="workshops_registers">
                                    <a class="submenu" href="<?= admin_url('workshops/registers'); ?>">
                                    <i class="fa fa-newspaper-o"></i>
                                    <span class="text"> <?= lang('List_registers_event'); ?></span>
                                </a>
                                </li>

...
<script>
    $(document).ready(function () {
        oTable = $('#BrandTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('products/getBrands') ?>',
...
<?= admin_form_open('products/brand_actions', 'id="action-form"') ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?php echo admin_url('products/add_brand'); ?>" data-toggle="modal" data-target="#myModal">
                                <i class="fa fa-plus"></i> <?= lang('add_brand') ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo admin_url('products/import_brands'); ?>" data-toggle="modal" data-target="#myModal">

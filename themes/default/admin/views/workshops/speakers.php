...
<script>
    $(document).ready(function () {
        oTable = $('#BrandTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('workshops/getSpeakers') ?>',
...
<?= admin_form_open('workshops/speaker_actions', 'id="action-form"') ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?php echo admin_url('workshops/add_speaker'); ?>" data-toggle="modal"
                                data-target="#myModal">

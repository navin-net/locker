...
<script>
    $(document).ready(function () {
        oTable = $('#PrRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('workshops/getRegister_reports/?v=1' . $v) ?>',
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('workshops/getRegister_reports/pdf/?v=1' . $v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('workshops/getRegister_reports/0/xls/?v=1' . $v)?>";
            return false;
        });

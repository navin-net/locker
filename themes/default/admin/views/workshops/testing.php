...
<script>
    $(document).ready(function () {
        oTable = $('#PrRData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('workshops/getTesting/?v=1' . $v) ?>',
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="form">
                    ...
                    <?php echo admin_form_open('workshops/testing', 'autocomplete="off"'); ?>
                    <div class="row">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=admin_url('workshops/getTesting/pdf/?v=1' . $v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=admin_url('workshops/getTesting/0/xls/?v=1' . $v)?>";
            return false;
        });

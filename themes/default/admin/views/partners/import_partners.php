...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('import partners'); ?></h4>
        </div>
        <?php
        $attrib = ['class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form'];
        echo admin_form_open_multipart('partners/import_partners', $attrib)
        ?>
        <div class="modal-body">
            <a href="<?php echo base_url(); ?>assets/csv/sample_partners.csv" class="btn btn-primary pull-right">
            ...
            <div class="well well-small">
                ...
                <span class="text-info">
                 (<?= lang('name') . ', ' . lang('phone') . ', ' .lang('email'). ', ' .lang('website') . ', ' .lang('facebook') .', ' .lang('twitter'). ', '.lang('telegram'). ', '.lang('intagram'), ', '.lang('address'); ?>)
                </span> <?= lang('csv3'); ?>
            </div>
